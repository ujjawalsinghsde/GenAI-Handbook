...
This project implements a retrieval-augmented generation (RAG) system that enables users to query YouTube video content without watching the entire video. The system automatically:

* Extracts video transcripts
* Indexes transcript content for fast retrieval
* Answers user questions using retrieved transcript segments as context

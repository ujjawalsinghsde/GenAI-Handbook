...
## **1. Why Do We Need Tools in LangChain?**

LLMs (like GPT, Claude, LLaMA) are extremely good at:

* **Reasoning** → understanding questions, analyzing tasks
* **Language generation** → creating detailed responses

But they **cannot perform real-world actions** such as:

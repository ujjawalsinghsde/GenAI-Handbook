...
## 1️⃣ What is Text Splitting?
**Text Splitting** means breaking a large document into **smaller chunks** before sending it to an LLM.

Why?

* LLMs **cannot read unlimited text**
* Embeddings work **poorly** on very large text
* Retrieval (RAG) needs **focused, meaningful chunks**

👉 Think of it like this:

> *You don’t revise an entire book before an exam — you revise chapter by chapter.*
...
## 1️⃣1️⃣ Where Text Splitter Fits in RAG Pipeline
